...
export default function FooterSection({ contact }: FooterSectionProps) {
  return (
    <footer className="bg-[var(--color-primary)] px-6 py-12 text-center text-white">
      <Reveal variant="up">
        <p className="text-lg font-bold">Hubungi Kami</p>
      </Reveal>
          ...
          {contact.contact_instagram_url && (
            <Reveal variant="up" delay={120}>
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-neutral-800 transition hover:opacity-90 hover:scale-110"
              >
