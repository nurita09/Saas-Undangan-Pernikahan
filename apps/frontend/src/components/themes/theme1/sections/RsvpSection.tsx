...
export default function RsvpSection({ guestName }: RsvpSectionProps) {
  ...
  const inputClass =
    'mt-2 w-full border border-[var(--fl-gold)]/30 bg-[var(--fl-card)] px-4 py-3 font-floral-serif text-lg normal-case tracking-normal text-[var(--fl-ink)] outline-none transition-colors placeholder:text-[var(--fl-muted)]/60 focus:border-[var(--fl-clay)]';
      ...
      <div className="relative mx-auto max-w-md">
        <Reveal variant="bloom">
          ...
          <p className="mx-auto mt-7 max-w-sm text-center font-floral-serif text-lg leading-relaxed text-[var(--fl-muted)]">
            Doa, harapan, dan ucapan terbaik dari Anda akan menjadi kenangan indah yang selalu kami
            hargai.
          </p>
        </Reveal>
        ...
        <Reveal variant="bloom" delay={120}>
          <form onSubmit={handleSubmit} className="card-petal mt-10 px-7 py-9">
            ...
            <p className="label-caps mt-6 text-[var(--fl-muted)]">Konfirmasi Kehadiran</p>
                ...
                <button
                  ...
                  className={`label-caps flex items-center justify-center gap-2 border px-3 py-3.5 transition-colors duration-500 ${
                    status === value
                      ...
                      : 'border-[var(--fl-gold)]/30 bg-[var(--fl-card)] text-[var(--fl-muted)] hover:border-[var(--fl-clay)]'
                  }`}
                >
        ...
        <div className="mt-9 max-h-[500px] space-y-4 overflow-y-auto pr-1">
          {rsvps.map((rsvp) => (
            <div key={rsvp.id} className="card-petal px-6 py-5">
