...
export default function LeftPane({
  ...
  return (
    <div className="hidden lg:flex lg:flex-1 lg:sticky lg:top-0 lg:h-screen relative flex-col items-center justify-center overflow-hidden z-10">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,0.24),rgba(0,0,0,0.08)_45%,rgba(0,0,0,0.22))]" />
      <FloralCorners
        spots={["tl", "tr", "bl", "br"]}
        size="w-60"
        opacity="opacity-85"
      ...
      <div className="relative z-20 max-w-2xl px-8 text-center text-white">
        ...
        <h1 className="mt-6 font-floral-script text-7xl leading-[1.03] drop-shadow-[0_2px_18px_rgba(0,0,0,0.35)] xl:text-8xl">
          {couple.groom_name}{" "}
