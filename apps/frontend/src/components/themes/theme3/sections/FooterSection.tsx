...
export default function FooterSection({ contact }: FooterSectionProps) {
  return (
    <footer className="border-t border-[var(--dk-line)] bg-[var(--dk-surface)] px-6 py-12 text-center text-[var(--dk-ivory)]">
      <Reveal variant="up">
        <p className="text-[0.6rem] font-semibold uppercase tracking-[0.38em] text-[var(--color-primary)]">
          Hubungi Kami
        </p>
      </Reveal>
          ...
          {contact.contact_instagram_url && (
            <Reveal variant="up" delay={120}>
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-[var(--dk-line)] text-[var(--color-primary)] transition hover:scale-105 hover:border-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-[var(--color-secondary)]"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
      ...
      {contact.contact_handle && (
        <Reveal variant="up" delay={360}>
          <p className="mt-6 text-sm font-medium text-[var(--dk-muted)]">
            {contact.contact_handle}
          </p>
        </Reveal>
      )}
