...
const WeddingEditor = lazy(() => import("./pages/WeddingEditor.tsx"));
...
export default function App() {
  ...
  if (state.status === "error") {
    return (
      <InvitationNotFound message="Terjadi kesalahan saat memuat undangan, coba lagi nanti." />
    );
  }
  ...
  return (
    <Suspense fallback={<LoadingScreen />}>
      <ThemeComponent data={state.data} guestName={guestName} />
    </Suspense>
  );
}
